...
namespace Employees.Pages
{
    public partial class EmployeeDetail
    {
        ...
        private List<Country> Countries { get; set; } = default!;

        private List<JobCategory> JobCategories { get; set; } = default!;
        ...
        protected override Task OnInitializedAsync()
        {
            ...
            InitializeEmployees();
            Employee = Employees.FirstOrDefault(e => e.EmployeeId == int.Parse(this.EmployeeId))!;
